...
#python train.py --dataset SDD --dataset_path ../datasets/SDD/archive --tag CTAG.g1.t3.th.0.2_gates --thres 0.2 --n_gcnn 1 --n_tcnn 3 --scene_name gates --num_epochs 250  --lr 0.01
#python train.py --dataset SDD --dataset_path ../datasets/SDD/archive --tag CTAG.g1.t3.th.0.2_deathCircle --thres 0.2 --n_gcnn 1 --n_tcnn 3 --scene_name deathCircle --num_epochs 250  --lr 0.01
#python train.py --dataset SDD --dataset_path ../datasets/SDD/archive --tag CTAG.g1.t3.th.0.2_coupa --thres 0.2 --n_gcnn 1 --n_tcnn 3 --scene_name coupa --num_epochs 250  --lr 0.01
#python train.py --dataset SDD --dataset_path ../datasets/SDD/archive --tag CTAG.g1.t3.th.0.2_bookstore --thres 0.2 --n_gcnn 1 --n_tcnn 3 --scene_name bookstore --num_epochs 250 --lr 0.01
